...
const SELF_HOST_CONFIG_DIR = '/root/.dexis/config';
/**
 * @type {Array<{ from: string; to?: string, modifier?: (content: string): string }>}
 */
const configFiles = [
  { from: './.env.example', to: '.env' },
  { from: './dist/config/dexis.js', modifier: configCleaner },
  { from: './dist/config/dexis.env.js', modifier: configCleaner },
];
