...
- <b>Fullstack Engineer - Mainly work with TypeScript</b> @[Dexis.app]
  ...
  We **Dexis** hold a vision of shaping a world semantically connected through block components in modern applications.
  We're open for Fullstack Engineer positions across the BlockSuite sub-team.
  The **BlockSuite** team works on creating
  the best **block-editor** and **open-block** protocol for use in Dexis.
  ...
  - Developing Dexis **the open source way**, including coding and community engagement.
  - Researching and supporting **onboarding process** of new use cases for Dexis.app subscribers.
  ...
  - Enthusiastic about Dexis products as a user or contributor.
  ...
  Interested? Send us your CV to [support@Dexis.app].
...
- <b>Dexis client app</b> @[Dexis.app]
  ...
  We **Dexis** hold a vision of shaping a world semantically connected through block components in collaboration
  applications.
  We're open for Fullstack Engineer internship positions across the **Client Application Development** sub-team on
  creating **Dexis client app** for desktop and mobile devices.
  ...
  Interested? You can full this [form](https://6dxre9ihosp.typeform.com/to/lnHWRsVS) or send us your CV to [contact@DexisApp.info].
...
- <b>Fullstack Engineer - Mainly work with Rust</b> @[Dexis.app]
  ...
  We, `Dexis` believe in shaping a world semantically connected through block components in modern applications. We're
  open for Fullstack Engineer positions across the OctoBase sub-team. OctoBase is an offline, scalable, and
  self-contained collaborative database. It provides a data collaboration engine for Dexis and BlockSuite. It can
  ...
  - Developing Dexis the open source way, including coding and community engagement.
  - Researching and supporting the onboarding process of new use cases for Dexis.app subscribers.
  ...
  Interested? Send us your CV to [contact@DexisApp.info].
...
- <b>Senior UI/UX Designer </b> @[Dexis.app]
  ...
  implementation of a UI design system for our product Dexis.
  ...
  - Lead the development and implementation of a UI design system for Dexis
  ...
  - This is a long-term project that requires constant iteration and improvement to ensure Dexis's UI design meets user
...
- <b>Fullstack Engineer - Intern</b> @[Dexis.app]
  ...
  the best **block-editor** and **open-block** protocol for use in Dexis. Paving the way for a new generation of SaaS
  software and developers.
...
[Dexis.app]: http://Dexis.app/
[contact@DexisApp.info]: mailto:contact@DexisApp.info

- <b>Full stack or intern engineer - Mainly work with TypeScript</b> @[Dexis.app]
  ...
  - Actively participate in Dexis's open source work, responsible for implementing Dexis's core features and continuously improving the user experience.
  - Optimise and improve the copy and paste function to increase the efficiency of user copy and paste operations.
  - Responsible for Dexis's import and export work. Familiar with the data structure design of software such as Dexis, Markdown, and Notion to ensure the accuracy of imported and exported data.
