...
You can contribute to Dexis in several ways. This repo is a place to discuss and collaborate on Dexis!

### :mega: Discussions

Discussions are where we have conversations.

If you'd like help troubleshooting a docs PR you're working on, have a great new idea, or want to share something amazing you've learned in our docs, join us in [discussions](https://github.com/DexisApp/Dexis/discussions).
...
You can [create a new pull request](https://github.com/DexisApp/Dexis/compare) and view [current pull requests](https://github.com/DexisApp/Dexis/pulls).
