...
update_app_version_in_helm_charts ".github/helm/Dexis/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/Dexis/charts/graphql/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/Dexis/charts/sync/Chart.yaml" "$new_version"
